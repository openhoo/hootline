...
export function buildBenchmarkRow({
  ...
  return {
    ...
    cacheReadTokens: attempt?.lastCacheReadTokens,
    cacheWriteTokens: attempt?.lastCacheWriteTokens,
    totalTokens: attempt?.lastTotalTokens,
    toolCallCount: attempt?.lastToolCallCount,
    toolErrorCount: attempt?.lastToolErrorCount,
